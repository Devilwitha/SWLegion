...
class LegionDatabase:
    def __init__(self):
        ...
        self.upgrades = [
            ...
            {"name": "DLT-19 Stormtrooper", "type": "Heavy Weapon", "points": 20, "restricted_to": ["Stormtroopers"], "adds_mini": True},
            {"name": "HH-12 Stormtrooper", "type": "Heavy Weapon", "points": 16, "restricted_to": ["Stormtroopers"], "adds_mini": True},
            {"name": "T-21B Shoretrooper", "type": "Heavy Weapon", "points": 32, "restricted_to": ["Shoretroopers"], "adds_mini": True},
            {"name": "RT-97C (Snowtrooper)", "type": "Heavy Weapon", "points": 24, "restricted_to": ["Snowtroopers"], "adds_mini": True},
            ...
            {"name": "Z-6 Trooper", "type": "Heavy Weapon", "points": 20, "restricted_to": ["Rebel Troopers"], "adds_mini": True},
            {"name": "MPL-57 Ion Trooper", "type": "Heavy Weapon", "points": 18, "restricted_to": ["Rebel Troopers"], "adds_mini": True},
            ...
            "Galaktisches Imperium": [
                {
                    ...
                    "slots": ["Force", "Force", "Command"], "info": "Deflect, Immune: Pierce", "minis": 1,
                ...
                },
                {
                    ...
                    "slots": ["Force", "Force", "Force", "Command"], "info": "Pulling the Strings", "minis": 1,
                ...
                },
                {
                    ...
                    "slots": ["Command", "Gear"], "info": "Spotter 2, Inspire 1", "minis": 1,
                ...
                },
                {
                    ...
                    "slots": ["Training", "Gear", "Armament", "Comms"], "info": "Loadout, Marksman, Nimble", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Precise 1", "minis": 4,
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Target 1, Coordinate", "minis": 4,
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Steady", "minis": 4,
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Training", "Comms", "Gear", "Grenades"], "info": "Disciplined 1, Precise 2", "minis": 4,
                    "speed": 2, "defense": "Red", "surge": {"attack": "hit", "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Training", "Gear", "Grenades"], "info": "Low Profile, Scout 1", "minis": 2,
                ...
                },
                {
                    ...
                    "slots": ["Comms"], "info": "Cover 1, Speeder 1", "minis": 2,
                ...
                },
                {
                    ...
                    "slots": ["Training", "Comms", "Armament"], "info": "Armor 1, Relentless", "minis": 1,
                    "speed": 1, "defense": "Red", "surge": {"attack": "hit", "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Pilot", "Hardpoint", "Hardpoint", "Comms"], "info": "Armor, Arsenal 2", "minis": 1,
                    "speed": 2, "defense": "White", "surge": {"attack": "hit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Training", "Training", "Gear", "Gear", "Comms"], "info": "Bounty, Jump 2, Impervious, Arsenal 2", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                    "weapons": [
            ...
            "Rebellenallianz": [
                {
                    ...
                    "slots": ["Force", "Force", "Gear"], "info": "Jump 1, Charge, Deflect", "minis": 1,
                ...
                },
                {
                    ...
                    "slots": ["Command", "Gear"], "info": "Inspire 2, Nimble, Take Cover 2", "minis": 1,
                ...
                },
                {
                    ...
                    "slots": ["Command", "Training", "Gear"], "info": "Gunslinger, Low Profile", "minis": 1,
                    "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Nimble", "minis": 4,
                    "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Defend 1, Coordinate", "minis": 4,
                    "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                    "weapons": [{"name": "A-280 Blaster Rifle", "range": [1, 3], "dice": {"red": 0, "black": 1, "white": 0}, "keywords": []}]
                },
                {
                    "name": "Rebel Commandos", "points": 48, "rank": "Special Forces", "hp": 1, "courage": 2,
                    "slots": ["Heavy Weapon", "Training", "Gear", "Grenades"], "info": "Low Profile, Scout 2", "minis": 4,
                    "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                    "weapons": [{"name": "A-280 Blaster Rifle", "range": [1, 3], "dice": {"red": 0, "black": 1, "white": 0}, "keywords": []}]
                },
                {
                    "name": "Wookiee Warriors", "points": 69, "rank": "Special Forces", "hp": 3, "courage": 2,
                    "slots": ["Heavy Weapon", "Training", "Training", "Gear", "Grenades"], "info": "Charge, Duelist, Indomitable", "minis": 3,
                ...
                },
                {
                    ...
                    "slots": ["Hardpoint", "Comms"], "info": "Armor, Climbing Vehicle", "minis": 1,
                    "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Pilot", "Hardpoint", "Comms"], "info": "Armor, Arsenal 2, Speeder 2", "minis": 1,
                    "speed": 3, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
            ...
            "Separatistenallianz": [
                {
                    ...
                    "slots": ["Command", "Training", "Gear", "Armament"], "info": "Arsenal 2, Block, Jedi Hunter", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Force", "Force", "Force", "Command"], "info": "Cunning, Deflect, Immune: Pierce", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Command", "Command", "Comms", "Gear"], "info": "Strategist 1, Direct: AI", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Comms", "Electrobinoculars"], "info": "AI: Attack, Coordinate: Droid", "minis": 6,
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Comms"], "info": "AI: Attack, Armor 1", "minis": 3,
                    "speed": 2, "defense": "White", "surge": {"attack": None, "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Training", "Gear", "Grenades", "Comms"], "info": "AI: Move/Attack, Scale, Scout 3", "minis": 5,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Comms"], "info": "Shields 4, Wheel Mode", "minis": 2,
                ...
                },
                {
                    ...
                    "slots": ["Pilot", "Hardpoint", "Comms"], "info": "Armor, Arsenal 2", "minis": 1,
            ...
            "Galaktische Republik": [
                {
                    ...
                    "slots": ["Force", "Force", "Command", "Training"], "info": "Guardian 3, Soresu Mastery", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Command", "Training", "Gear", "Grenades"], "info": "Gunslinger, Scout 1, Tactical 1", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Force", "Force", "Training"], "info": "Deflect, Djem So Mastery, Tempted", "minis": 1,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Fire Support", "minis": 4,
                    "speed": 2, "defense": "Red", "surge": {"attack": None, "defense": None},
                ...
                },
                {
                    ...
                    "slots": ["Heavy Weapon", "Personnel", "Training", "Gear"], "info": "Reliable 1", "minis": 4,
                    "speed": 2, "defense": "Red", "surge": {"attack": None, "defense": None},
                    "weapons": [{"name": "DC-15A Blaster Rifle", "range": [1, 3], "dice": {"red": 0, "black": 1, "white": 0}, "keywords": []}]
                },
                {
                    "name": "ARC Troopers", "points": 72, "rank": "Special Forces", "hp": 1, "courage": 2,
                    "slots": ["Heavy Weapon", "Personnel", "Training", "Gear"], "info": "Impervious, Jetpacks, Tactical 1", "minis": 4,
                    "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                ...
                },
                {
                    ...
                    "slots": ["Crew", "Comms"], "info": "Cover 1, Speeder 1", "minis": 1,
             ...
             "Schattenkollektiv": [
                 {
                     ...
                     "slots": ["Force", "Force", "Command", "Armament"], "info": "Juyo Mastery, Allies of Convenience", "minis": 1,
                     "speed": 2, "defense": "Red", "surge": {"attack": "crit", "defense": "block"},
                 ...
                 },
                 {
                     ...
                     "slots": ["Command", "Gear", "Armament"], "info": "Aid, Danger Sense 2", "minis": 1,
                     "speed": 2, "defense": "White", "surge": {"attack": "hit", "defense": "block"},
                 ...
                 },
                 {
                     ...
                     "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Dauntless, Indomitable", "minis": 4,
                     "speed": 2, "defense": "White", "surge": {"attack": "crit", "defense": "block"},
                     "weapons": [{"name": "Blaster Pistol", "range": [1, 2], "dice": {"red": 0, "black": 1, "white": 1}, "keywords": []}]
                 },
                 {
                     "name": "Pyke Syndicate Foot Soldiers", "points": 40, "rank": "Corps", "hp": 1, "courage": 1,
                     "slots": ["Heavy Weapon", "Personnel", "Gear", "Grenades"], "info": "Danger Sense 2, Independent: Dodge 1", "minis": 4,
                     "speed": 2, "defense": "White", "surge": {"attack": "hit", "defense": "block"},
